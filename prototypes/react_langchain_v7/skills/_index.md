...
Call `read_skill(name)` with the exact name from the Name column.

| Name | Description |
|------|-------------|
| knowledge-ops | Retrieve and answer questions about people, projects, dates, events, and recent activity |
| relationship-ops | Map connections between entities, trace who belongs to what, resolve references |
